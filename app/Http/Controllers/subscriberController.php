...
class subscriberController extends Controller
 {
    ...
    public function subscriberdetailsbyname( Request $request ) {
        $validate = Validator::make( $request->all(), [
            'subscriber_firstname'	=> 'required',
        ] );
        if ( $validate->fails() ) {
        ...
        $personal = DB::table( 'subscriber' )
        ->select( '*' )
        ->where( 'subscriber_firstname', '=', $request->subscriber_firstname )
        ->where( 'status_id', '=', 1 )
        ->first();
        $activations = DB::table( 'activations' )
        ->select( '*' )
    ...
    public function subscriberdetailsbyemail( Request $request ) {
        $validate = Validator::make( $request->all(), [
            'subscriber_email'	=> 'required',
        ] );
        if ( $validate->fails() ) {
        ...
        $personal = DB::table( 'subscriber' )
        ->select( '*' )
        ->where( 'subscriber_email', '=', $request->subscriber_email )
        ->where( 'status_id', '=', 1 )
        ->first();
        $activations = DB::table( 'activations' )
        ->select( '*' )
    ...
    public function subscriberdetailsbyphone( Request $request ) {
        $validate = Validator::make( $request->all(), [
            'subscriber_contactnumber'	=> 'required',
        ] );
        if ( $validate->fails() ) {

            return response()->json( 'Contact Number Is Required', 400 );
        }
        $personal = DB::table( 'subscriber' )
        ->select( '*' )
        ->where( 'subscriber_contactnumber', '=', $request->subscriber_contactnumber )
        ->where( 'status_id', '=', 1 )
        ->first();
        $activations = DB::table( 'activations' )
        ->select( '*' )
